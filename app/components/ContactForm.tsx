    ...
    return (   <form onSubmit={handleSubmit}>
        <div className="grid md:grid-cols-2 gap-4 w-full py-2">
          <div className="flex flex-col">
            ...
            <input id="name" autoComplete="off" required minLength={3} maxLength={150}
          ...
          <div className="flex flex-col">
            ...
            <input id="phone" autoComplete="off" minLength={9} maxLength={20}
              className="border-2  rounded border-neutral-300 p-3"
              type="text"
            />
          </div>
        ...
        <div className="flex flex-col py-2">
          ...
          <input id="email" autoComplete="off" required minLength={8} maxLength={150}
            className="border-2  rounded border-neutral-300 p-3"
            type="email"
          />
        </div>
        ...
        <div className="flex flex-col py-2">
          ...
          <textarea id="message" autoComplete="off" required minLength={20} maxLength={600}
            className="border-2 rounded border-neutral-300 p-3"
            rows={10}
          />
        </div>
        <button type="submit" className="w-full p-4 mt-4 text">Send Message</button>
      </form> );
}
