...
const About: React.FC = () => {
  return (
    <div
      id="about"
      className="w-full  h-screen p-2 flex items-center py-16 mb-20 bg-gradient-to-b from-[rgba(219,248,207,0.1)]   via-transparent to-transparent "
    >
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className=" flex flex-col items-center justify-center col-span-2 font-pt">
          ...
          <div className="py-10">
            <button onClick={openResume} className="px-8 py-2 bg-[rgba(219,248,207,0.1)] ">Resume</button>
          </div>
        </div>
        ...
        <div className="md:h-full  px-20  md:p-10 m-auto bg-transparent flex justify-center items-center hover:scale-105 ease-in duration-500">
          <Image
            className="border-4 border-[#e5e7eb] object-contain shadow-md shadow-stone-400"
            src="/Vivien.jpg"
            width={200}
            height={400}
            alt="Vivien's face"
